...
let helloFromConstructoy = new String('안녕하세요?');       // 생성자 함수로 생성
...
console.log(newStr);
newStr = sample.replace(/[ㄱ-ㅎ ㅏ-ㅣ 가-힣]/g, '');    //한글은 제거
console.log(newStr);

//문자열의 일부분을 추출
let str = 'Apple, Banana, Kiwi';
console.log(str.slice(7, 7+6+1));       //Banana (시작 인덱스, 끝 인덱스)
console.log(str.slice(7));              //Banana, Kiwi (시작 인덱스)
console.log(str.substring(7, 13));      //Banana (시작 인덱스, 끝 인덱스)
console.log(str.substr(7,6));           //Banana (시작 인덱스, 갯수), deprecate

//문자열을 특정 문자열을 기중으로 배열로 만들기 
...
// console.log(numbers.split('9').length-1);
